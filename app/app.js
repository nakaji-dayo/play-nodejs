...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cycleSocket = __webpack_require__(63);

	var _cycleSocket2 = _interopRequireDefault(_cycleSocket);
	...
	function main(_ref) {
	  ...
	  return {
	    DOM: SocketIO.get('result').merge(SocketIO.get('clear').map(function (x) {
	      return { clear: true };
	    })).scan(function (xs, x) {
	      console.log('test:' + x);
	      xs.push(x);
	      ...
	      return (0, _view2.default)({ lines: x });
	    })
	  };
	}
	...
	var drivers = {
	  ...
	  SocketIO: _cycleSocket2.default.createSocketIODriver(window.location.origin)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _socketIoClient = __webpack_require__(64);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parsejson = __webpack_require__(106);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(98)('engine.io-client:polling-xhr');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parser = __webpack_require__(88);
	var inherit = __webpack_require__(97);
	var debug = __webpack_require__(98)('engine.io-client:polling');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parseqs = __webpack_require__(96);
	var inherit = __webpack_require__(97);
	var debug = __webpack_require__(98)('engine.io-client:websocket');
	...
	var WebSocket = __webpack_require__(103);
